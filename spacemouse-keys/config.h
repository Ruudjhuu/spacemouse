...
following deadzone.
*/
#define DEADZONE 20 // Recommended to have this as small as possible to allow full range of motion.
...
//              {HES0, HES1, HES2, HES3, HES6, HES7, HES8, HES9}
#define MINVALS {-152, -63, -152, -149, -225, -45, -146, -84}
#define MAXVALS {55, 72, 67, 62, 54, 51, 46, 64}
...
#define SENS_TX 0.80
#define SENS_TY 0.99
#define SENS_PTZ 1.4 // sensitivity for positive translation z
#define SENS_NTZ 1.2 // sensitivity for negative translation z
#define GATE_NTZ                                                                                   \
